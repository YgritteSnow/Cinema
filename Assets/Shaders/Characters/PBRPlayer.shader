...
Shader "* Character/PBR Player" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) 
		{
			...
			o.Metallic = mss.r;
			o.Smoothness = mss.g;
			o.Emission = mask.b * _SelfIlluminateColor + detailFlowMask.g * flowTex * _FlowColor * _FlowColor.a + _SelfIlluminated * IN.depthAndFesnel.y * _SelfIlluminateColor;;
			//o.Normal = UnpackNormal(normal);
			o.Normal = UnpackNormalMapWithAlpha(finalNormal); 
